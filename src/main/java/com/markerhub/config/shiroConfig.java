...
/**
 * 下面的ShiroConfig，我们主要做了几件事情：
 *
 * 引入RedisSessionDAO和RedisCacheManager，为了解决shiro的权限数据和会话信息能保存到redis中，实现会话共享。(如果日后扩展业务，由此可以做负载均衡和集群)
...
public class shiroConfig{
    ...
    public ShiroFilterChainDefinition shiroFilterChainDefinition() {
        ...
        filterMap.put("/**", "jwt");  //这个 jwt 跟下面的 shiroFilterFactoryBean 方法中 filters 中的 jwt对应，实际上就是 jwtFilter
